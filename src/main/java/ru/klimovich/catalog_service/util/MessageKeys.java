...
public class MessageKeys {
    ...
    public static final String CATEGORY_NOT_FOUND_ID_KEY = "Category not found with id: [%s].";
    ...
    public static final String CATEGORY_DELETE_SUCCESSFULLY = "he category was successfully deleted.";
